...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.markWidth = 1.0;
        self.selectedBarColor = [UIColor colorWithRed:68/255.0 green:142/255.0 blue:33/255.0 alpha:1.0];
        self.unselectedBarColor = [UIColor colorWithRed:203/255.0 green:198/255.0 blue:198/255.0 alpha:1.0];
